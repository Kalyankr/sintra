...
class TestLookupQuantizationBenchmarks:
    ...
    def test_different_bit_widths(self):
        ...
        assert (
            result_4bit["benchmark_results"]["tps_range"][0]
            > result_8bit["benchmark_results"]["tps_range"][0]
        )
        assert (
            result_4bit["benchmark_results"]["accuracy_drop"]
            > result_8bit["benchmark_results"]["accuracy_drop"]
        )
